...
plotnoise.line(dfplot['timestamp'], dfplot['db'], color='olivedrab', alpha=0.5)
plothumid.line(dfplot['timestamp'], dfplot['humidity'], color='indigo', alpha=0.5)
plotcount.line(dfplot['timestamp'], dfplot['count'], color='olive', alpha=0.5)
